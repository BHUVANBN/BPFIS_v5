    ...
    <div className="min-h-screen flex flex-col bg-[#f7f0de]">
      ...
      <main className="flex-grow flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-md bg-[#fffaf1] border border-[#e2d4b7] rounded-lg shadow-md px-8 py-10">
          <h1 className="text-2xl font-semibold text-center text-[#1f3b2c] mb-2">Create Supplier Account</h1>
          <p className="text-xs text-center text-[#6b7280] mb-8">
            Enter your details to list your products on the AgriLink marketplace.
          </p>

          {!otpStage ? (
            <form onSubmit={handleRegister} className="space-y-4">
              <div>
                <label className="block text-xs font-medium text-[#374151] mb-1">Company Name</label>
                <input
                  type="text"
                  value={companyName}
              ...
              <div>
                <label className="block text-xs font-medium text-[#374151] mb-1">Business Email</label>
                <input
                  type="email"
                  value={businessEmail}
              ...
              <div>
                <label className="block text-xs font-medium text-[#374151] mb-1">UPI ID</label>
                <input
                  type="text"
                  value={upiId}
